/**************************************************************************
 ...
 MODIFIED by Steven for smart lock OLED testing
 **************************************************************************/
...
Serial.println(F("check 2"));  //debugging checkpoint
...
Serial.println(F("check 3"));//debugging checkpoint
...
Serial.println(F("testing checkpoint 4 ")); //debugging checkpoint
